...
public class Game {
    ...
    public void play() {
        ...
        System.out.println("Varsågod att välja 1--spela med dator  eller  2-- spela med människor");
        ...
        if (choose == 1) {
            ...
            player2 = new Robot(name2, "O");
            answer = "ja";
        } else if (choose == 2) {
            player1 = new Human(name1, "X");
            player2 = new Human(name2, "O");
            answer = "ja";
        }
        ...
        while (answer.equals("ja")) {
            ...
            while (board.isBoardFull() == false && winner == false) {                                                      // while loop to loop and add vinster.
                // if board is not full then user1 inputs number, check if he is a winner.
                if (board.isBoardFull() == false && winner == false) {                                                     //check if place is not occupied and here is not winner.
                    while (true) {                                                                                         // if place is occupied and loop again
                        ...
                        if (board.isPlaceOccupied(i - 1) == false) {                                                      // if the place is not occupied
                            ...
                            if (board.checkWinner() == true) {                                                              // check winner
                                ...
                                if (answer.equals("nej")) {
                                    System.out.println(player1.getName() + " har fått " + player1.score + " vinster");
                                    System.out.println(player2.getName() + " har fått " + player2.score + " vinster");
                                }
                                break;
                            }
                            break;
