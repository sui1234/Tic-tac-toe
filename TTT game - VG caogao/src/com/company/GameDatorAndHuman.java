...
public class GameDatorAndHuman {
                            ...
                            if (board.isPlaceOccupied(i - 1) == false) {                                                      // if the place is not occupied
                                ...
                                if (board.checkWinner() == true) {
                                    ...
                                    if(answer.equals("nej")){
                                        System.out.println(player1.getName() + ": du har fått "+ player1.score +" vinster");
                                        System.out.println(player2.getName() + ": du har fått "+ player2.score +" vinster");
                                    }
